...
void processLoggedInPlayer( Socket *inSock,
	...
	newOject.clothing.backpack = getObject( 87838 );
    }
    if( newObject.nation == 11 ) {
        ...
        newOject.clothing.backpack = getObject( 87842 );
    }
    if( newObject.nation == 12 ) {
        ...
        newOject.clothing.backpack = getObject( 87840 );
    }
    if( newObject.nation == 13 ) {
        ...
        newOject.clothing.backpack = getObject( 87844 );
    }
